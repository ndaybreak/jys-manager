...
<script>
  import { otcTempateFetchAll, otcTempateCreate, otcTempateUpdate, otcTempateDelete, otcTempateCopy } from '@/api/customer'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        otcTempateFetchAll(this.query).then(result => {
      ...
      handleDelete(row) {
        this.$confirm(this.$t('tip.del'), this.$t('tip.warning'), {
          ...
          otcTempateDelete(row.id).then(res => {
            this.$message({
              type: 'success',
      ...
      createData() {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            otcTempateCreate(this.tempInfo).then(data => {
      ...
      updateData() {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            otcTempateUpdate(this.tempInfo, this.updatingObj).then((res) => {
              this.getList()
              this.dialogFormVisible = false
              this.$notify({
                title: this.$t('tip.successTitle'),
      ...
      copyData() {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            otcTempateCopy(this.tempInfo).then((res) => {
              this.getList()
              this.dialogFormVisible = false
              this.$notify({
                title: this.$t('tip.successTitle'),
