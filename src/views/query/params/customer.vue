<template>
  <div class="app-container">
    ...
    <el-table :data="list" border fit highlight-current-row
      ...
      <el-table-column align="center" label="ID" width="120" prop="customer_level_id"></el-table-column>
...
<script>
  import { customerLevelLog } from '@/api/query'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        customerLevelLog(para).then(response => {
