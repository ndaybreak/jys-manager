<template>
  <div class="app-container">
    ...
    <el-table :data="list" border fit highlight-current-row
      ...
      <el-table-column align="center" :label="$t('table.mobile_number')" width="180" prop="mobileNumber"></el-table-column>
      <el-table-column align="center" :label="$t('table.coin')" width="100" prop="coinCode"></el-table-column>
      <el-table-column align="center" :label="$t('table.balance_change')" width="150" prop="commissionAmount"></el-table-column>
      <el-table-column align="center" :label="$t('table.commissionRate')" width="150" prop="commissionRate"></el-table-column>
      <el-table-column align="center" :label="$t('table.commissionTotalAmount')" width="150" prop="commissionTotalAmount"></el-table-column>
