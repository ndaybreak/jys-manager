<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input style="width: 200px;" class="filter-item" :placeholder="$t('tip.templateRemark')" v-model="query.description"></el-input>
    ...
    <el-table :data="list" border fit highlight-current-row
      ...
      <el-table-column align="center" :label="$t('table.templateNo')" width="150" prop="code"></el-table-column>
      <el-table-column align="center" :label="$t('table.templateLang')" width="150">
        <template slot-scope="scope">
          <span>{{scope.row.language | languageFilter}}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.remark')" width="250" prop="description"></el-table-column>
      <el-table-column :label="$t('table.content')" prop="content"></el-table-column>
